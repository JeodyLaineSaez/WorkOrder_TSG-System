...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('workorders', '0009_alter_workorder_date_requested'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='workorders.computertechnician')),
